...
| 2 | North Europe | Standard_B2s | 4 (3 VMs) |
| 3 | UK South | Standard_B2s | 2 |
| 4 | West Europe | Standard_B2s | 4 (2 VMs) |
...
├── demo3-vnet-peering-transitivity.tf     # Terraform - Lab 2
├── demo2-private-link-dns.tf              # Terraform - Lab 3
├── demo4-load-balancer-snat.tf            # Terraform - Lab 4
...
| 2 | 3 VMs (hub-spoke) | ~£0.08 |
| 3 | Storage + Private Endpoint + VM | ~£0.05 |
| 4 | Load Balancer + NAT GW + 2 VMs | ~£0.10 |
| 5 | 2 VMs (D2s_v3) | ~£0.15 |
